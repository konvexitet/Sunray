...
#define WIFI_SSID "mlnet2"            // choose WiFi network ID
#define WIFI_PASS "stavhopp470"      // choose WiFi network password
...
//#define REQUIRE_VALID_GPS  false    // mower wi+ll continue to mow if no float or no fix solution (not recommended)
